...
class ThemeDropdown<T> extends StatefulWidget {
  ...
  @override
  State<ThemeDropdown<T>> createState() => ThemeDropdownState<T>();
}

class ThemeDropdownState<T> extends State<ThemeDropdown<T>> with TickerProviderStateMixin {
